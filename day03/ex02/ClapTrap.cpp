...
ClapTrap::ClapTrap(std::string const &name, unsigned int hitP, unsigned int maxHit, unsigned int energy,
				   unsigned int maxEnergy, unsigned int level, unsigned int meleeDmg, unsigned int rangeDmg,
				   unsigned int armor): _name(name), _hitPoints(hitP), _maxHitPoints(maxHit),
